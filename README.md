...
| Robert Capa — Cieszyn Humanist Photojournalism | Tworzy anglojęzyczne prompty inspirowane bliskością reporterską, dynamiką chwili i humanistycznym dokumentem. | Cieszyn i Český Těšín; dalmierzowy look 35 mm/50 mm; monochromatyczna faktura analogowa; etyka i jawne oznaczanie rekonstrukcji. | **Specyfikacja i 5 scenariuszy zapisane; prompt-agent, bez kodu wykonawczego.** | [Dokumentacja](agents/photo/robert-capa-cieszyn.md) |
